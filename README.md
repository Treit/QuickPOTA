...
Once the wizard finishes, each line at the `[n] >` prompt is one of:
    ...
    [time] <call> [time] [sent/rcvd | rcvd] [qth] [notes]
                                                Log a contact.
